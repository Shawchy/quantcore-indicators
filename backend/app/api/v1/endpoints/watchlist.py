...
async def get_watchlist(current_user: CurrentUser):
...
async def remove_from_watchlist(code: str, current_user: CurrentUser):
...
async def get_watchlist_quotes(current_user: CurrentUser):
