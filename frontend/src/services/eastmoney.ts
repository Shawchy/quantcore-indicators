...
export const eastMoneyApi = {
  ...
  getStockChanges: (symbol: string = '大笔买入') =>
    api.get<StockChange[]>('/eastmoney/changes', { params: { symbol } }),

  /**
   * 获取板块异动详情
   */
  getBoardChanges: () =>
    api.get<StockBoardChange[]>('/eastmoney/board-changes'),
  ...
  getZtPool: (date?: string) =>
    api.get<StockZtPool[]>('/eastmoney/zt-pool', { params: { date } }),

  /**
   * 获取市场异动汇总
   */
  getMarketChangesSummary: () =>
    api.get<MarketChangesSummary>('/eastmoney/market-changes-summary'),

  /**
   * 获取所有异动类型列表
   */
  getChangeTypes: () =>
    api.get<ChangeType[]>('/eastmoney/change-types'),
  ...
  getZtPoolPrevious: (date?: string) =>
    api.get<StockZtPrevious[]>('/eastmoney/zt-pool-previous', { params: { date } }),
  ...
  getZtPoolStrong: (date?: string) =>
    api.get<StockZtStrong[]>('/eastmoney/zt-pool-strong', { params: { date } }),
  ...
  getZtPoolSubNew: (date?: string) =>
    api.get<StockZtSubNew[]>('/eastmoney/zt-pool-sub-new', { params: { date } }),

  /**
   * 获取千股千评数据
   */
  getStockComment: () =>
    api.get<StockComment[]>('/eastmoney/stock-comment'),
  ...
  getStockCommentDetailInstitution: (symbol: string) =>
    api.get<StockCommentDetailInstitution[]>(`/eastmoney/stock-comment-detail-institution/${symbol}`),
  ...
  getStockCommentDetailScore: (symbol: string) =>
    api.get<StockCommentDetailScore[]>(`/eastmoney/stock-comment-detail-score/${symbol}`),
  ...
  getStockResearchReport: (symbol: string) =>
    api.get<StockResearchReport[]>(`/eastmoney/stock-research-report/${symbol}`),
  ...
  getStockNoticeReport: (symbol: string = '全部', date?: string) =>
    api.get<StockNotice[]>('/eastmoney/stock-notice-report', { params: { symbol, date } }),
  ...
  getBalanceSheetReport: (symbol: string) =>
    api.get<StockBalanceSheet[]>(`/eastmoney/balance-sheet-report/${symbol}`),
  ...
  getBalanceSheetYearly: (symbol: string) =>
    api.get<StockBalanceSheet[]>(`/eastmoney/balance-sheet-yearly/${symbol}`),
  ...
  getProfitSheetReport: (symbol: string) =>
    api.get<StockProfitSheet[]>(`/eastmoney/profit-sheet-report/${symbol}`),
  ...
  getProfitSheetYearly: (symbol: string) =>
    api.get<StockProfitSheet[]>(`/eastmoney/profit-sheet-yearly/${symbol}`),
  ...
  getProfitSheetQuarterly: (symbol: string) =>
    api.get<StockProfitSheet[]>(`/eastmoney/profit-sheet-quarterly/${symbol}`),
  ...
  getCashFlowSheetReport: (symbol: string) =>
    api.get<StockCashFlowSheet[]>(`/eastmoney/cash-flow-sheet-report/${symbol}`),
  ...
  getCashFlowSheetYearly: (symbol: string) =>
    api.get<StockCashFlowSheet[]>(`/eastmoney/cash-flow-sheet-yearly/${symbol}`),
  ...
  getCashFlowSheetQuarterly: (symbol: string) =>
    api.get<StockCashFlowSheet[]>(`/eastmoney/cash-flow-sheet-quarterly/${symbol}`),
  ...
  getStockAConestionLG: () =>
    api.get<StockAConestionLG[]>('/eastmoney/stock-a-congestion-lg'),

  /**
   * 获取乐咕乐股 - 股债利差
   */
  getStockEBSLG: () =>
    api.get<StockEBSLG[]>('/eastmoney/stock-ebs-lg'),

  /**
   * 获取乐咕乐股 - 巴菲特指标
   */
  getStockBuffettIndexLG: () =>
    api.get<StockBuffettIndexLG[]>('/eastmoney/stock-buffett-index-lg'),
  ...
  getStockZhValuationBaidu: (symbol: string, indicator?: string, period?: string) =>
    api.get<StockZhValuationBaidu[]>(
      `/eastmoney/stock-zh-valuation-baidu/${symbol}`,
  ...
  getStockValueEM: (symbol: string) =>
    api.get<StockValueEM[]>(`/eastmoney/stock-value-em/${symbol}`),
  ...
  getStockZhVoteBaidu: (symbol: string, indicator?: string) =>
    api.get<StockZhVoteBaidu[]>(
      `/eastmoney/stock-zh-vote-baidu/${symbol}`,
  ...
  getStockAHighLowStatistics: (symbol?: string) =>
    api.get<StockAHighLowStatistics[]>('/eastmoney/stock-a-high-low-statistics', {
  ...
  getStockABelowNetAssetStatistics: (symbol?: string) =>
    api.get<StockABelowNetAssetStatistics[]>('/eastmoney/stock-a-below-net-asset-statistics', {
   ...
   */
  getStockDzjySctj: () =>
    api.get<StockDzjySctj[]>('/eastmoney/stock-dzjy-sctj'),
  ...
  getStockDzjyMrmx: (symbol?: string, start_date?: string, end_date?: string) =>
    api.get<StockDzjyMrmx[]>('/eastmoney/stock-dzjy-mrmx', {
  ...
  getStockMarginRatioPa: (symbol?: string, date?: string) =>
    api.get<StockMarginRatioPa[]>('/eastmoney/stock-margin-ratio-pa', {
  ...
  getStockMarginAccountInfo: () =>
    api.get<StockMarginAccountInfo[]>('/eastmoney/stock-margin-account-info'),
  ...
  getStockMarginSse: (startDate: string, endDate: string) =>
    api.get<StockMarginSse[]>('/eastmoney/stock-margin-sse', {
  ...
  getStockMarginDetailSse: (date: string) =>
    api.get<StockMarginDetailSse[]>(`/eastmoney/stock-margin-detail-sse/${date}`),
  ...
  getStockMarginSzse: (date: string) =>
    api.get<StockMarginSzse[]>(`/eastmoney/stock-margin-szse/${date}`),
  ...
  getStockMarginDetailSzse: (date: string) =>
    api.get<StockMarginDetailSzse[]>(`/eastmoney/stock-margin-detail-szse/${date}`),
  ...
  getStockMarginUnderlyingInfoSzse: (date: string) =>
    api.get<StockMarginUnderlyingInfoSzse[]>(`/eastmoney/stock-margin-underlying-info-szse/${date}`),
  ...
  getStockProfitForecastEm: (symbol?: string) =>
    api.get<StockProfitForecastEm[]>('/eastmoney/stock-profit-forecast-em', {
  ...
  getStockBoardIndustryNameEm: () =>
    api.get<StockBoardIndustryNameEm[]>('/eastmoney/stock-board-industry-name-em'),
  ...
  getStockBoardIndustrySpotEm: (symbol: string) =>
    api.get<StockBoardIndustrySpotEm[]>(`/eastmoney/stock-board-industry-spot-em/${symbol}`),
  ...
  getStockBoardIndustryConsEm: (symbol: string) =>
    api.get<StockBoardIndustryConsEm[]>(`/eastmoney/stock-board-industry-cons-em/${symbol}`),
};
